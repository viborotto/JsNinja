...
*/
var sul = ['Paraná', 'Santa Catarina', 'Rio Grande do Sul'], sudeste = ['Espírito Santo', 'Minas Gerais', 'Rio de Janeiro', 'São Paulo'];
...
*/
var newBrasil = [];
brasil.forEach(function(item, index){//executa a função uma vez por item
